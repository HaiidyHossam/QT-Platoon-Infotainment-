...
void MqttClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MqttClient::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MqttClient::speedChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MqttClient::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MqttClient::rpmChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MqttClient::speedChanged(int _t1)
{
...
// SIGNAL 1
void MqttClient::rpmChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
