...
QT_MOC_LITERAL(1, 11, 15), // "positionUpdated"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 1), // "x"
QT_MOC_LITERAL(4, 30, 1), // "y"
QT_MOC_LITERAL(5, 32, 15), // "messageReceived"
QT_MOC_LITERAL(6, 48, 7), // "message"
QT_MOC_LITERAL(7, 56, 14), // "QMqttTopicName"
QT_MOC_LITERAL(8, 71, 5) // "topic"

    },
    "MqttClient\0positionUpdated\0\0x\0y\0"
...
void MqttClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->positionUpdated((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (MqttClient::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MqttClient::positionUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MqttClient::positionUpdated(int _t1, int _t2)
{
